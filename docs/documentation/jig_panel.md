...
The **jig panel** or operator panel is a web interface that displays and controls the testing process in **Jig**.

## Capability

**Jig panel** allows you to:

- Start and stop testing;
- Interact with [dialog box](jig_panel.md#dialog-box) during testing;
- Browse:
    - Test suite name.
...
You can set one of the following operator panel languages ​​via the [configuration file](jig_config.md#language):
...
Use the [jig run](./cli.md#jig-run) command to start the web server.
...
- **Test stand info** - additional test stand parameters
  from [set_dut_info](./pytest_jig.md#set_dut_info) info;
...
The menu can be configured in `jig.toml`:
...
See the [configuration documentation](jig_config.md#reports_storage_menu) for details.
...
=== "Desktop layout"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/full_screen_button_big.png" alt="Full-size button desktop layout" style="width:600px;">
    </h1>

=== "Mobile horizontal"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/full_screen_button_phone_gorizontal.png" alt="Full-size button mobile horizontal" style="width:400px;">
    </h1>

=== "Mobile vertical"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/ful_screen_button_phone_vertical.png" alt="Full-size button mobile vertical" style="width:200px;">
    </h1>
...
**Configuration:**
Enable the auto scroll in your `jig.toml`:
...
1. Enable manual collect mode in your `jig.toml`:
...
<h1 align="center">
    <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/manual_collect_enabled.png" alt="Manual collect mode enabled" style="width:600px;">
</h1>

### Dialog box

For user interaction with the test, it is possible to use [dialog boxes](./pytest_jig.md#dialogbox).
An example of usage can be seen in the example [dialog box](../examples/dialog_box.md) and in [dialog box documentation](pytest_jig.md#run_dialog_box).
...
=== "Widget"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/base_dialog_box.png" alt="base_dialog_box">
    </h1>

=== "Widget with image"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/base_dbx_with_image.png" alt="base_dialog_box_with_image">
    </h1>

=== "Widget with HTML with link"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_html_link.png" alt="base_dialog_box_with_html_link">
    </h1>

=== "Widget with HTML with raw code"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_html_raw_code.png" alt="base_dialog_box_with_html_raw_code">
    </h1>

=== "Widget with pass/fail buttons"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/base_dbx_with_pass_fail.png" alt="base_dialog_box_with_pass_fail">
    </h1>

=== "Widget with custom pass/fail buttons"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/base_dbx_pass_fail_custom.png" alt="base_dialog_box_with_custom_pass_fail">
    </h1>
...
=== "Widget"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/text_input_dialog_box.png" alt="text_input_dialog_box">
    </h1>

=== "Widget with image"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_text_input_and_image.png" alt="text_input_dialog_box_with_image">
    </h1>

=== "Widget with HTML"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_text_input_and_html.png" alt="text_input_dialog_box_with_html">
    </h1>

=== "Widget with pass/fail buttons"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_text_input_and_pass_fail.png" alt="text_input_dialog_box_with_pass_fail">
    </h1>
...
=== "Widget"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/num_input_dialog_box.png" alt="num_input_dialog_box">
    </h1>

=== "Widget with image"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_num_input_and_image.png" alt="num_input_dialog_box_with_image">
    </h1>

=== "Widget with html"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_num_input_and_html.png" alt="num_input_dialog_box_with_html">
    </h1>

=== "Widget with pass/fail buttons"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_num_input_and_pass_fail.png" alt="num_input_dialog_box_with_pass_fail">
    </h1>
...
=== "Widget"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/radiobutton_dialog_box.png" alt="radiobutton_dialog_box">
    </h1>

=== "Widget with image"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_radio_and_image.png" alt="radiobutton_dialog_box_with_image">
    </h1>

=== "Widget with html"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_radio_and_html.png" alt="radiobutton_dialog_box_with_html">
    </h1>

=== "Widget with pass/fail buttons"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_radio_and_pass_fail.png" alt="radiobutton_dialog_box_with_pass_fail">
    </h1>
...
=== "Widget"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/checkbox_dialog_box.png" alt="checkbox_dialog_box">
    </h1>

=== "Widget with image"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_checkbox_and_image.png" alt="checkbox_dialog_box_with_image">
    </h1>

=== "Widget with html"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_checkbox_and_html.png" alt="checkbox_dialog_box_with_html">
    </h1>

=== "Widget with pass/fail buttons"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dbx_with_checkbox_and_pass_fail.png" alt="checkbox_dialog_box_with_pass_fail">
    </h1>
...
=== "Step 1"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dialog_box_with_steps.png" alt="dialog_box_with_steps">
    </h1>

=== "Step 2"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dialog_box_with_step_with_image.png" alt="dialog_box_with_step_with_image">
    </h1>

=== "Step 3"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dialog_box_with_step_with_html.png" alt="dialog_box_with_step_with_html">
    </h1>
...
or in the function description [set_operator_message](./pytest_jig.md#set_operator_message).
...
<h1 align="center">
    <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dialog_box_alert.png" alt="alert">
</h1>
...
<h1 align="center">
    <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/dialog_box/dialog_box_notification.png" alt="notification">
</h1>
...
<h1 align="center">
    <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/charts/basic_line_chart.png" alt="basic_line_chart">
</h1>
...
<h1 align="center">
    <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/charts/mult_dataset_chart.png" alt="multiple_datasets_chart">
</h1>
...
<h1 align="center">
    <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/charts/collapsed_chart.png" alt="collapsed_chart">
</h1>
...
<h1 align="center">
    <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/charts/expanded_chart.png" alt="expanded_chart">
</h1>
...
<h1 align="center">
    <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/charts/chart_log_x.png" alt="logarithmic_x_chart">
</h1>
...
<h1 align="center">
    <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/charts/chart_log_y.png" alt="logarithmic_y_chart">
</h1>
...
<h1 align="center">
    <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/charts/chart_log_x_log_y.png" alt="logarithmic_xy_chart">
</h1>
...
**Configuration**:
Enable and customize modal results in your `jig.toml`:
...
=== "PASS modal result"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/modal_result_pass.png" alt="PASS modal result" style="width:400px;">
    </h1>

=== "FAIL modal result"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/modal_result_fail.png" alt="FAIL modal result" style="width:400px;">
    </h1>

=== "STOP modal result"
    <h1 align="center">
        <img src="https://raw.githubusercontent.com/everypinio/jig/main/docs/img/modal_result_stop.png" alt="STOP modal result" style="width:400px;">
    </h1>
